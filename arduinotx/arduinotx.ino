...
** 20-08-2021 v1.6.0 updated syntax for compatibility with IDE v1.8.14 (PGM_P syntax errors). Not fully tested.
	Sketch uses 15752 bytes (48%) of program storage space. Maximum is 32256 bytes.
	Global variables use 589 bytes (28%) of dynamic memory, leaving 1459 bytes for local variables. Maximum is 2048 bytes.
** 11-04-2022 v1.6.1 removed reference to avr/pgmspace.h (not used in this version)
* 
